...
export const text = {
  ...
  // オセロの知育要素（v0.16.2。仕様§4.1）
  othelloCountLabel: 'かずのせんせい',
  othelloTipTitle: 'ワンポイント',
  othelloTips: [
    'かどを とると つよいよ！',
    'かどの となりは あとで とられやすいよ',
    'はしっこの いしは ひっくりかえされにくいよ',
    'たくさん かえせる ところを さがそう',
    'あいてが おける ばしょを へらそう',
    'さいごまで あきらめないで！ ぎゃくてん できるよ',
  ],
  othelloCountHint: 'タップで とばせるよ',
  // しちならべの数直線演出（v0.16.2。仕様§4.2）
  sevensNeighborSuffix: 'の となり！',
